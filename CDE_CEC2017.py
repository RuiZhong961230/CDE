...
def RunCDE():
    ...
    np.savetxt("./CDE_Data/CEC2017/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./CDE_Data/CEC2017') == False:
        os.makedirs('./CDE_Data/CEC2017')
    Dims = [30, 50]
    for Dim in Dims:
        main(Dim)
